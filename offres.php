...
<body>
    ...
    <main class="container">
        <div class="search-and-sort">
            <div class="d-flex">
                <form class="col-8 mb-3 mb-lg-0 me-lg-3 d-flex" role="search">
                    <input type="search" class="form-control" placeholder="Search..." aria-label="Search">
                    <button class="btn btn-primary">Chercher</button>
                </form>
                <div class="col-2">
                    <select class="form-select" aria-label="Ordre">
                ...
                <div class="col-2">
                    <select class="form-select" aria-label="Direction">
        ...
        <div class="content mt-5">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <?php
                include 'basedonnee/getallemploi.php';
                generateCardsFromTable('emploi');
              ?>
